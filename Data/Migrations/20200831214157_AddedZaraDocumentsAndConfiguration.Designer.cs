...
namespace ZAVOD_KZZ.Data.Migrations
{
    ...
    [Migration("20200831214157_AddedZaraDocumentsAndConfiguration")]
    partial class AddedZaraDocumentsAndConfiguration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZAVOD_KZZ.Core.Models.AdditionalDocumentZara", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<double>("FileExtension");
                    ...
                    b.Property<int>("OfficialDocumentZaraId");

                    b.Property<string>("UniqueFileName");

                    b.HasKey("Id");

                    b.HasIndex("OfficialDocumentZaraId");

                    b.ToTable("additional_documents_zara");
                });
            ...
            modelBuilder.Entity("ZAVOD_KZZ.Core.Models.DocumentStatusZara", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("document_zara_status");
                });

            modelBuilder.Entity("ZAVOD_KZZ.Core.Models.DocumentTypeZara", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ZAVOD_KZZ.Core.Models.NaturalChangePopulation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int?>("InfantDeath");

                    b.Property<int>("LiveBirth");
                    ...
                    b.ToTable("natural_change_population");
                });
            ...
            modelBuilder.Entity("ZAVOD_KZZ.Core.Models.OfficialDocumentZara", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<DateTime?>("DocumentEffectiveDate");

                    b.Property<DateTime?>("DocumentIneffectiveDate");

                    b.Property<string>("DocumentRemark");

                    b.Property<int>("DocumentStatusZaraId");

                    b.Property<int>("DocumentTypeZaraId");
                    ...
                    b.HasIndex("DocumentStatusZaraId");

                    b.HasIndex("DocumentTypeZaraId");

                    b.HasIndex("OfficalSpatialNewsId");

                    b.ToTable("official_document_zara");
                });
            ...
            modelBuilder.Entity("ZAVOD_KZZ.Core.Models.Railroad", b =>
                {
                    ...
                    b.Property<DateTime?>("ReconstructionDateEnd");

                    b.Property<DateTime?>("ReconstructionDateStart");
            ...
            modelBuilder.Entity("ZAVOD_KZZ.Core.Models.RailroadLocalGovernment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<decimal>("RailroadLength")
                        .HasMaxLength(9);
                    ...
                    b.ToTable("local_government_railroads");
                });
            ...
            modelBuilder.Entity("ZAVOD_KZZ.Core.Models.RequiredDocumentZara", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("required_documents_zara");
                });
            ...
            modelBuilder.Entity("ZAVOD_KZZ.Core.Models.AdditionalDocumentZara", b =>
                {
                    b.HasOne("ZAVOD_KZZ.Core.Models.OfficialDocumentZara", "OfficialDocumentZara")
                        .WithMany("AdditionalDocumentsZara")
                        .HasForeignKey("OfficialDocumentZaraId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("ZAVOD_KZZ.Core.Models.OfficialDocumentZara", b =>
                {
                    b.HasOne("ZAVOD_KZZ.Core.Models.DocumentStatusZara", "DocumentStatusZara")
                        .WithMany()
                        .HasForeignKey("DocumentStatusZaraId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ZAVOD_KZZ.Core.Models.DocumentTypeZara", "DocumentTypeZara")
                        .WithMany()
                        .HasForeignKey("DocumentTypeZaraId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("ZAVOD_KZZ.Core.Models.RailroadLocalGovernment", b =>
                {
                    ...
                    b.HasOne("ZAVOD_KZZ.Core.Models.Railroad", "Railroad")
                        .WithMany()
            ...
            modelBuilder.Entity("ZAVOD_KZZ.Core.Models.RequiredDocumentZara", b =>
                {
                    b.HasOne("ZAVOD_KZZ.Core.Models.OfficialDocumentZara", "OfficialDocumentZara")
                        .WithMany("RequiredDocumentsZara")
                        .HasForeignKey("OfficialDocumentZaraId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
